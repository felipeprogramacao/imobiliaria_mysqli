...
<div class=>
  ...
  <li class="list-group-item list-group-item-light">Terreno  <b><?php echo   $telefone; ?></b></li>
  ...
  <li class="list-group-item list-group-item-light">Corretor <b><?php echo   $proprietario; ?></b></li></li>
